...
API_ID = int(environ.get('API_ID', '1740849725'))
...
request_channel = environ.get('REQUEST_CHANNEL', '-1002316461830') # If anyone sends a request message to your bot, you will get it in this channel.
