...
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/Anna_movies_group1')
...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002209177912'))
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002133097035')) #
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://graph.org/file/171019ecb79d02d9017b7-49458029c916a3bc27.jpg')).split()
